...
void print_usage()
{
    ...
    std::cout << "  --bdd:sift-max-var          max number of variables to get sifted [1]" << std::endl;
    std::cout << "  --bdd:sift-max-growth       max percentage BDD growth during sifting [5]" << std::endl;
